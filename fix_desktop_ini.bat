...
REM 1. Git에서 desktop.ini 완전 제거
echo ================================================================================
echo 📝 Step 1: Git에서 desktop.ini 제거
echo ================================================================================
git rm -f --cached desktop.ini 2>nul
git rm -f --cached "**/desktop.ini" 2>nul
git rm -f --cached .git/refs/desktop.ini 2>nul
echo ✅ Git 캐시에서 desktop.ini 제거 완료
echo.

REM 2. 로컬 desktop.ini 파일 삭제
echo ================================================================================
echo 📝 Step 2: 로컬 desktop.ini 파일 삭제
echo ================================================================================
del /f /s /q /a:h desktop.ini 2>nul
del /f /s /q /a:h Thumbs.db 2>nul
echo ✅ 로컬 desktop.ini 파일 삭제 완료
echo.

REM 3. .git/refs/desktop.ini 특별 처리
echo ================================================================================
echo 📝 Step 3: .git/refs/desktop.ini 제거
echo ================================================================================
if exist .git\refs\desktop.ini (
    attrib -h -s .git\refs\desktop.ini
...
echo ================================================================================
findstr /C:"desktop.ini" .gitignore >nul
if %errorlevel%==0 (
...
echo 📝 Step 6: 변경사항 확인
echo ================================================================================
git status --porcelain | findstr /C:"desktop.ini" >nul
if %errorlevel%==0 (
    echo 📤 변경사항 커밋 중...
    git add .gitignore
